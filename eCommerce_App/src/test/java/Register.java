...
//import org.seleniumhq.selenium:selenium-devtools-v103:4.1.2;

//SC1:  REGISTER ACCOUNT
...
public class Register {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.navigate().to("https://www.jumia.com.eg/customer/account/create/");
        ...
        driver.findElement(By.xpath("//label[@text()='I accept the']")).click();
        Thread.sleep(3000);
